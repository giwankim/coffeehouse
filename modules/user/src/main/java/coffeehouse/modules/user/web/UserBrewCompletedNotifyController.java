...
public class UserBrewCompletedNotifyController {
  ...
  public UserBrewCompletedNotifyController(UserBrewCompleted userBrewCompleted) {
    this.userBrewCompleted =
        Objects.requireNonNull(userBrewCompleted, "UserBrewComplete must not be null");
  }

  @PostMapping
  public ResponseEntity<Void> notifyCompletedBrewToUser(
      @RequestBody UserBrewCompleteCommand command) {
